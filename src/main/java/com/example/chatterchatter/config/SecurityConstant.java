...
public class SecurityConstant {
    ...
    public static final String ACCESS_DENIED_MESSAGE = "Xou do not have permission to access this page";
    public static final String OPTIONS_HTTP_METHOD = "OPTIONS";
    public static final String[] PUBLIC_URLS = {"/api/user/login", "/api/user/register" ,"/api/user/reset-password/**"};
